						...
						>
							...
							<div className="relative z-[2]">
								...
								<p className="text-base mt-2 text-[#434344] dark:text-grey-100">
									Open Data Platform by OpenBB (ODP) is the open-source toolset that helps engineers connect their data sources to downstream applications like AI copilots and research dashboards.
								</p>
								<p
									className={clsx(
