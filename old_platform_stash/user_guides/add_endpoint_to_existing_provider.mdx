...
<HeadTitle title="Add Command To An Existing Provider - How-To | OpenBB Docs" />
...
The process will be very similar to adding a data provider to an existing endpoint - described on [this page](/platform/developer_guide/tutorials/add_new_provider_to_existing_extension) -
