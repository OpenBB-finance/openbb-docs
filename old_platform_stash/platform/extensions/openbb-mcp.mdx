...
The, [openbb-mcp-server](https://pypi.org/project/openbb-mcp-server/), Python package is for converting FastAPI instances or OpenBB environments, into Workspace-compatible MCP servers accessible from the chat interface.
