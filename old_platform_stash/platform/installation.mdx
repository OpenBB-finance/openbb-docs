...
Most systems capable of running Python `3.10-3.13` will be compatible with the OpenBB Platform. A modern processor (five years or less), running an up-to-date operating system, with at least 8GB of RAM, is recommended. Maintaining the system with current patches ensures maximum compatibility. At a minimum, Windows and macOS should be:
...
If you're interested in building a [Docker](/platform/installation#docker) container, skip ahead to the specific section [below](/platform/installation#docker).
