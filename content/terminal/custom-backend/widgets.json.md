...
| data.table.columnsDefs.renderFnParams | `object`                  | Required if `renderFn` cellOnClick is used. Specifies the parameters for the render function. Example: `{"actionType": "groupBy"}`. object.                                 |
