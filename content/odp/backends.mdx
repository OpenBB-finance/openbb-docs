...
Create a new backend by pressing the, `New Backend`, button near the top of the page.
...
- Copy and paste multi-line text for environment variables, and/or add a `.env` file.
...
:::note
Backend server management is intended for single-user, desktop operating systems.
:::
...
| Service fails to terminate on ODP exit. | This is likely a bug, please report on [Github](https://github.com/OpenBB-finance/OpenBB/issues/) with contextual details.
