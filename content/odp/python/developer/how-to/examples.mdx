...
This page explains how to add examples and code snippets to API and Python endpoints.
Usage examples are defined in the [router](/odp/python/developer/extension_types/router)
and are expected to provide working syntax, with descriptions for complex functions requiring many parameters.
