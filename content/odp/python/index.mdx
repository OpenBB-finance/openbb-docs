...
Go to the [installation](/odp/python/installation) page for detailed instructions, and see the [extensions](/odp/python/extensions) page for information on individual components.

:::tip Looking for a graphical method, or having trouble with virtual environments?
Go to the [ODP Desktop](/odp/desktop/installation) to get started.
:::
...
The [developer](/odp/python/developer) pages provide an orientation to the codebase, as well as technical details and snippets for working with it.
