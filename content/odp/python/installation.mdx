...
For a graphical installer, see the [ODP Desktop](/odp/desktop/installation) application.

### Setup Environment

:::tip
If you are having trouble with virtual environments or package installation, use the ODP [Desktop Application](/odp/desktop/installation) instead.
:::
...
If you're interested in building a [Docker](/odp/python/installation#docker) container, skip ahead to the specific section [below](/odp/python/installation#docker).
...
See the [quickstart](/odp/python/quickstart) guide for getting started with the ODP Python Package.
