...
Servers can be extensively configured in a manner similar to [`openbb-api`](/odp/python/extensions/interface/openbb-api), the Minimum Viable Python approach.
...
Go [here](/odp/python/settings/mcp_settings) to see the complete table.
