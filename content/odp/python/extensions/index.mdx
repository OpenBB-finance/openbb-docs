...
Anyone can build and publish [installable extensions](/odp/python/developer/extension_types) for the OpenBB ecosystem.
...
<ul className="grid grid-cols-1 gap-2 -ml-6">
  <NewReferenceCard
    ...
    url="/odp/python/extensions/providers/"
  />
  <NewReferenceCard
