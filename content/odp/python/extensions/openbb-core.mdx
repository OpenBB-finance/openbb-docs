...
General concepts and classes are explained on the [Architecture Overview](/odp/python/developer/architecture_overview) page.

Go to the [Extension Types](/odp/python/developer/extension_types) page to learn about, or get started building, OpenBB extensions.
