...
<HeadTitle title="Routines - | ODP CLI Docs" />
...
<ul className="grid grid-cols-1 gap-4 -ml-6">
  ...
  <NewReferenceCard
    ...
    description="Become an ODP CLI power user by understanding routines inputs, setting variables, creating loops and more."
