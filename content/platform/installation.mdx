...
:::danger
Users with versions below v1.0.3 will need to follow the steps below to update the version of OpenBB to the current.
...
Alternatively, uninstall and reinstall. The solution above is more time-efficient.
