...
<HeadTitle title="API keys | OpenBB Platform Docs" />

The API Keys page provides a secure and convenient way to manage and store your API credentials for various data providers.
