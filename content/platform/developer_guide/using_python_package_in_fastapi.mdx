...
sidebar_position: 4
description: This page provides guidance for importing the OpenBB Python interaface as a FastAPI dependency.
keywords:
- OBB
- Python
- Development
...
To incorporate within a larger API, create `OpenBBApp` in a separate file and then import it directly in each router file requiring it. 
