...
:::info
The `Fetcher` class implementation is based on the [TET pattern](/platform/developer-guide/architecture_overview#the-tet-pattern). This pattern imposes a standardized structure, namely:
